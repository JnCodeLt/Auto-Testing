...
try: 
    ...
    # Відкрити випадаючий список "eHealth"
    selectBtn = browser.find_element(By.CSS_SELECTOR, '#select2-id_is_ehealth-container')
    selectBtn.click()
    time.sleep(1)
    
    # Пошук по значенню "Так"
    selectDropdown = browser.find_element(By.CSS_SELECTOR, 'ul#select2-id_is_ehealth-results')
