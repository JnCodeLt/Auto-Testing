...
try: 
    ...
    # Відкрити випадаючий список "Тип"
    selectBtn = browser.find_element(By.CSS_SELECTOR, '#select2-id_type-container')
    selectBtn.click()
    time.sleep(1)
    
    # Пошук по значенню "Госпіталізація"
    selectDropdown = browser.find_element(By.CSS_SELECTOR, 'ul#select2-id_type-results')
    ...
    # Пошук по значенню "Лабораторне дослідження"
    selectDropdown = browser.find_element(By.CSS_SELECTOR, 'ul#select2-id_type-results')
    selectOptions = selectDropdown.find_elements(By.CSS_SELECTOR, 'li')
    ...
    # Пошук по значенню "eHealth послуга"
    selectDropdown = browser.find_element(By.CSS_SELECTOR, 'ul#select2-id_type-results')
    selectOptions = selectDropdown.find_elements(By.CSS_SELECTOR, 'li')
